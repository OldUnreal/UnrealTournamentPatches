...
* Fixed a bug that could cause a TeamCannon to freeze the game if their target died while the Cannon was in the ActiveCannon state
...
* The script compiler now correctly recompiles classes for which instances exist in the editor level
